...
local scriptURL = "https://raw.githubusercontent.com/pot0to/pot0to-SND-Scripts/refs/heads/main/Gold%20Saucer/JumboCactpot.lua"
local ConfigFolder = os.getenv("appdata") .. "\\XIVLauncher\\pluginConfigs\\SomethingNeedDoing\\pot0to\\Weeklies\\"
